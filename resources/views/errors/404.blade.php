<x-guest-layout>
    <!-- component -->
    <div class="flex items-center p-5 overflow-hidden relative">
        <div
            class="flex-1 min-h-full min-w-full rounded-3xl shadow-xl p-10 text-gray-800
            relative md:flex items-center text-center md:text-left">
            <div class="w-full md:w-1/2">
                <div class="mb-10 md:mb-20 text-secondary-700 font-light dark:text-secondary-300">
                    <h1 class="font-black uppercase text-3xl lg:text-5xl text-yellow-500 mb-10">You seem to be
                        lost!</h1>
            ...
            <div class="w-full md:w-1/2 text-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 441.85 285.44"
                    ...
                    <path class="fill-none" d="M0 0h500v500H0z" id="BACKGROUND" />
                    <g id="OBJECTS">
                        <path class="st1"
